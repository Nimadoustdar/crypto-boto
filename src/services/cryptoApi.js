...
const API_KEY = 'CG-nNijg29E5K6jcZhKbL3YVbpk'
...
const marketCart = coin =>`${BASE_URL}/coins/${coin}/market_chart?vs_currency=usd&days=7`

export { getCoinList, searchCoin ,marketCart }